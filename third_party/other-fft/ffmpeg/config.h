...
#define FFMPEG_CONFIGURATION "--disable-everything --disable-avdevice --disable-avfilter --disable-bzlib --disable-doc --disable-ffprobe --disable-lzo --disable-network --disable-postproc --disable-swresample --disable-swscale --disable-zlib --enable-fft --enable-rdft --enable-shared --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --optflags=-O2 --enable-decoder='theora,vorbis,vp8' --enable-decoder='pcm_u8,pcm_s16le,pcm_s24le,pcm_f32le' --enable-decoder='pcm_s16be,pcm_s24be' --enable-demuxer='ogg,matroska,wav' --enable-parser='vp3,vorbis,vp8' --enable-pic --enable-cross-compile --cross-prefix=arm-linux-androideabi- --target-os=linux --arch=arm --enable-thumb --enable-neon --extra-cflags='-mfpu=neon' --extra-cflags='-march=armv7-a' --extra-cflags='-mtune=cortex-a8' --extra-cflags='--sysroot=/usr/local/google/code/clankium-master-2/src/third_party/android_tools/ndk//platforms/android-9/arch-arm/' --extra-cxxflags='--sysroot=/usr/local/google/code/clankium-master-2/src/third_party/android_tools/ndk//platforms/android-9/arch-arm/' --extra-ldflags='--sysroot=/usr/local/google/code/clankium-master-2/src/third_party/android_tools/ndk//platforms/android-9/arch-arm/' --extra-cflags='-mfloat-abi=softfp' --extra-libs=-lm --enable-decoder='aac,h264,mp3' --enable-demuxer='mp3,mov' --enable-parser='aac,h264,mpegaudio'"
