        ...
        int count)
{
    ...
    while (p0 < pEnd)
    {
        float32x4x2_t z0_v = vld2q_f32((const float*) p0);
        float32x4x2_t z1_v = vld2q_f32((const float*) p1);
        ...
        float32x4x2_t exp_v;
        exp_v = vld2q_lane_f32((const float*) exp0, exp_v, 0);
        exp0 += expTableStride;
        exp_v = vld2q_lane_f32((const float*) exp0, exp_v, 1);
        exp0 += expTableStride;
        exp_v = vld2q_lane_f32((const float*) exp0, exp_v, 2);
        exp0 += expTableStride;
        exp_v = vld2q_lane_f32((const float*) exp0, exp_v, 3);
        exp0 += expTableStride;
        ...
        exp_v = vld2q_lane_f32((const float*) exp1, exp_v, 0);
        exp1 -= expTableStride;
        exp_v = vld2q_lane_f32((const float*) exp1, exp_v, 1);
        exp1 -= expTableStride;
        exp_v = vld2q_lane_f32((const float*) exp1, exp_v, 2);
        exp1 -= expTableStride;
        exp_v = vld2q_lane_f32((const float*) exp1, exp_v, 3);
        exp1 -= expTableStride;
